...
Friend Class colLocation
	...
	Public Function Add(ByRef LOCID As String, ByRef LOCNAME As String, ByRef LOCADDR As String, ByRef LOCDESC As String, ByRef LOCPREFIX As String, ByRef colVLACC As colVlacc, Optional ByRef sKey As String = "") As clsLocation
		'create a new object
		Dim objNewMember As clsLocation
		objNewMember = New clsLocation
		
		
		'set the properties passed into the method
		objNewMember.LOCID = LOCID
		objNewMember.LOCNAME = LOCNAME
		objNewMember.LOCADDR = LOCADDR
		objNewMember.LOCDESC = LOCDESC
		objNewMember.LOCPREFIX = LOCPREFIX
		objNewMember.colVLACC = colVLACC
		If Len(sKey) = 0 Then
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As clsLocation
		Get
