Option Strict Off
Option Explicit On
Friend Class colVlacc
	Implements System.Collections.IEnumerable
	
	'local variable to hold collection
	Private mCol As Collection
	
	Public Function Add(ByRef ACCID As String, ByRef VTYPE As String, Optional ByRef sKey As String = "") As clsVlacc
		'create a new object
		Dim objNewMember As clsVlacc
		objNewMember = New clsVlacc
		
		
		'set the properties passed into the method
		objNewMember.ACCID = ACCID
		objNewMember.VTYPE = VTYPE
		If Len(sKey) = 0 Then
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As clsVlacc
		Get
